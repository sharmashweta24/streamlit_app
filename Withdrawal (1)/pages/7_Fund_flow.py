...
def money_flow_page():
    ...
    if username.strip(): 
        ...
        if not user_fund_details and not user_subscription_details:
            ...
            return
        st.markdown("<h2 style='color: orange;'>User Deposit Details</h2>", unsafe_allow_html=True)
        ...
        st.markdown("<h2 style='color: orange;'>User Subscription Details</h2>", unsafe_allow_html=True)
