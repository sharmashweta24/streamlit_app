    ...
    if st.button("Search"):
        if username == '':
            ...
            with ThreadPoolExecutor() as executor:
                ...
                trade_by_admin, trade_by_user, bot_by_user,bot_by_admin,total_trade_by_admin,total_trade_by_user,total_bot_by_user,total_bot_by_admin = future_leader_wise_user_subscription.result()
            ...
            with cols[0]:
                ...
                st.write(f'Total Left Side Coin Payment Deposits  : {e2}')
            ...
            with cols[1]:
                ...
                st.write(f'Total Left Side Coin Payment Deposits : {f2}')
            ...
            with cols[0]:
                ...
                st.write(f'Total Right Side Coin Payment Deposits: {g2}')
            ...
            with cols[1]:
                ...
                st.write(f'Total Right Side Coin Payment Deposits: {h2}')
            ...
            st.write("Total Trade by Admin",total_trade_by_admin)
            st.write("Total Trade by User",total_trade_by_user)
            st.write("Total Bot by Admin",total_bot_by_admin)
            st.write("Total Bot by User",total_bot_by_user)
            st.markdown("<h5 style='color: yellow;'>User Wise Subscription for Trade</h5>", unsafe_allow_html=True)
            cols = st.columns(2)
            with cols[0]:
                st.markdown("<h6 style='color: green;'>Admin</h6>", unsafe_allow_html=True)
                st.table(trade_by_admin)
            with cols[1]:
                st.markdown("<h6 style='color: green;'>User</h6>", unsafe_allow_html=True)
                st.table(trade_by_user)       

            st.markdown("<h5 style='color: yellow;'>User Wise Subscription for BOT</h5>", unsafe_allow_html=True)
            cols = st.columns(2)
            with cols[0]:
                st.markdown("<h6 style='color: green;'>Admin</h6>", unsafe_allow_html=True)
                st.table(bot_by_admin)
            with cols[1]:
                st.markdown("<h6 style='color: green;'>User</h6>", unsafe_allow_html=True)
                st.table(bot_by_user)     
